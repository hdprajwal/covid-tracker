        ...
        >
          <nav>
            <ul className="md:flex items-center justify-between text-base text-blue-600 pt-4 md:pt-0">
              <li>
                <p className=" no-underline text-gray-900 dark:text-white hover:text-gray-200 font-medium text-lg py-2 px-4 lg:-ml-2">
          ...
          >
            <div className="auth flex items-center w-full md:w-full">
              ...
              <div className="cursor-pointer" onClick={auth.logout}>
                <div className="dark:text-gray-100 p-4 w-full flex justify-center">
                  Logout
                </div>
              </div>
            </div>
